...
description: How amateur radio operators support disaster relief — phases of response, real-world examples, coordination with agencies, and lessons learned
published: true
date: 2026-04-05T09:30:00.000Z
tags: emergency, disaster, response, public-service, emcomm
editor: markdown
...
### Preparedness
Before any disaster occurs, amateur radio emergency communication groups prepare through training, exercises, and relationship-building with served agencies. This includes [ARES/RACES](/emergency-communications/ares) membership, [emergency communication training](/emergency-communications/emcomm-training), [go kit](/emergency-communications/go-kit) preparation, and establishing Memoranda of Understanding with local emergency management agencies, the Red Cross, hospitals, and other organizations.

### Response (first hours to first days)
...
**[SKYWARN](/emergency-communications/skywarn) reporting.** During weather-related disasters, continued severe weather reporting helps the NWS maintain warnings and forecasts for the affected area.
...
## What operators actually do during a deployment
...
**Digital message handling.** Operators running [Winlink](/digital-modes/winlink) stations provide email-like capability over radio. ICS forms, situation reports, resource requests, and other documents can be transmitted digitally when internet-based email is unavailable.

**Net control.** Experienced operators serve as [net control stations](/emergency-communications/emergency-nets) managing the flow of information across the radio network. This is one of the most demanding and important roles during a sustained operation.

## Notable amateur radio disaster responses
...
**Training is not optional.** Untrained operators who self-deploy to disaster areas create more problems than they solve. Formal training in ICS, message handling, and emergency operations is essential. See [EmComm Training](/emergency-communications/emcomm-training).
...
1. **Complete [emergency communication training](/emergency-communications/emcomm-training)** — At minimum, EC-001, IS-100, and IS-700
2. **Build and maintain a [go kit](/emergency-communications/go-kit)** at the level appropriate for your expected role
3. **Participate in exercises** — SETs, Field Day, tabletop exercises
4. **Check into [emergency nets](/emergency-communications/emergency-nets)** regularly to build operating skills
5. **Establish personal readiness** — 72-hour personal supplies, family emergency plan, ability to be away from home
6. **Build relationships** with local emergency management and served agencies
7. **Learn digital modes** — particularly [Winlink](/digital-modes/winlink) and [APRS](/digital-modes/aprs)
8. **Maintain your equipment** — Test regularly, keep batteries charged, update firmware and frequency lists
...
- [EmComm Training](/emergency-communications/emcomm-training) — Training programmes
- [Go Kit](/emergency-communications/go-kit) — Emergency equipment
- [Emergency Nets](/emergency-communications/emergency-nets) — Net operations
- [International Emergency Communications](/emergency-communications/international-emergency) — Global perspectives
- [Winlink](/digital-modes/winlink) — Email over radio
- [NVIS Propagation](/propagation/nvis) — Regional HF communication
