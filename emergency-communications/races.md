---
title: RACES (Radio Amateur Civil Emergency Service)
description: The US government RACES programme — legal basis, how it works, activation requirements, and relationship with ARES
published: true
date: 2026-04-05T09:30:00.000Z
tags: emergency, races, fema, civil-defense
editor: markdown
...
The Radio Amateur Civil Emergency Service (RACES) is a United States government programme that provides for amateur radio communication during civil emergencies. Unlike [ARES](/emergency-communications/ares), which is a volunteer programme run by the ARRL, RACES is established by federal regulation and operates under the authority of local, state, or federal emergency management agencies.
...
- A roster of enrolled amateur radio operators
- Equipment and frequencies for emergency operations
- Operating positions at local Emergency Operations Centres (EOCs)
...
1. Hold a valid FCC amateur radio licence
2. Register with a local RACES programme through the local emergency management agency
3. Be accepted and enrolled by the local RACES Officer or emergency management director
4. Complete any training requirements set by the local jurisdiction
...
1. **Declaration of emergency.** A government official (mayor, county executive, governor, or the President) must declare a civil emergency.
2. **RACES activation order.** The emergency management agency activates RACES as part of the emergency response.
3. **Operators report.** Enrolled RACES operators report to their assigned positions (typically the local EOC or designated staging areas).
4. **Operations.** RACES operators provide communication support under the direction of the emergency management agency. All communications must be related to civil defence purposes.
5. **Deactivation.** RACES operations continue until the emergency management agency deactivates the programme.
...
### Combined ARES/RACES programmes
...
- Local EOC orientation and familiarization
- RACES-specific operating procedures
- Equipment deployment and setup
- Message handling and net discipline
- [SKYWARN](/emergency-communications/skywarn) severe weather training (in many jurisdictions)

Many of these requirements overlap with [ARES training levels](/emergency-communications/emcomm-training), making it straightforward for operators to participate in both programmes.

## Equipment

RACES programmes typically maintain equipment at government facilities:

- **EOC stations** — Permanently installed radio stations at emergency operations centres
- **Mobile communication vehicles** — Some jurisdictions operate dedicated communication vehicles equipped for RACES operations
- **Portable equipment** — Deployable stations for field locations

Enrolled RACES operators are also expected to maintain personal equipment that they can bring when activated, similar to an [ARES go kit](/emergency-communications/go-kit).
...
- It provides a formal legal framework for amateur radio operation under government direction
- The enrollment and training process ensures that EOC radio positions are staffed by qualified operators
- Combined ARES/RACES programmes benefit from both the flexibility of ARES and the governmental authority of RACES
- Some emergency management agencies specifically require RACES enrollment for operators working in government facilities
