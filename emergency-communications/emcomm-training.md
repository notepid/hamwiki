...
description: Training programmes, courses, and certifications for amateur radio emergency communicators — ARRL, FEMA, and international options
published: true
date: 2026-04-05T09:30:00.000Z
tags: emergency, training, ics, nims, emcomm
editor: markdown
...
The ARRL offers a series of online courses specifically designed for amateur radio emergency communicators. These courses are part of the [ARES](/emergency-communications/ares) training framework.
...
- How emergency management works at local, state, and federal levels
- Served agency relationships and expectations
- Basic message handling and the ICS-213 message form
- Net operations and discipline
- Deployment considerations
- Personal preparedness

EC-001 is self-paced and available online through the ARRL website. It typically takes 20–30 hours to complete and includes quizzes and a final assessment. Completing EC-001 satisfies one of the [ARES Level 1](/emergency-communications/ares) training requirements.
...
- Leadership in emergency communication events
- Planning and organizing communication support
- Working with served agencies and emergency management officials
- Managing volunteers during deployments
- After-action reviews and continuous improvement
- Event communication planning for public service events
...
- Resource management
- How personnel fit into the ICS structure
...
### IS-300 and IS-400: Intermediate and Advanced ICS
...
## Incident Command System (ICS) essentials for ham operators
...
**[Winlink](/digital-modes/winlink) training.** Digital message handling over radio is increasingly important in emergency communications. Learning to use Winlink for sending and receiving email over radio, including form-based messages like ICS-213, is a valuable skill.

## SKYWARN spotter training

[SKYWARN](/emergency-communications/skywarn) training, provided free by local NWS Weather Forecast Offices, is relevant to emergency communicators even if severe weather is not the primary focus of your group. The training teaches:

- Severe weather recognition
- Reporting procedures and criteria
- Spotter safety
- How the NWS uses spotter reports
...
### Field Day
[Field Day](/community/field-day) is the ARRL's annual emergency preparedness exercise held on the fourth full weekend in June. While it has a contesting element, Field Day's core purpose is practicing field deployment — setting up stations under non-ideal conditions, operating on emergency power, and working outside the comfort of a home station.
...
Checking into weekly [emergency nets](/emergency-communications/emergency-nets) builds the operating discipline and procedural skills that are essential during real activations. Many ARES groups run a weekly or monthly training net specifically for this purpose.
...
- **United Kingdom** — RAYNET provides its own training programme for emergency communication volunteers, covering operational procedures, working with the UK emergency services, and deployment skills.
- **Canada** — Radio Amateurs of Canada (RAC) coordinates emergency communication training, often in conjunction with provincial emergency management agencies. Many provinces offer training modeled on ICS principles.
- **Australia** — WICEN (Wireless Institute Civil Emergency Network) provides training for volunteers supporting emergency services. The Australasian Inter-Service Incident Management System (AIIMS) is the equivalent of ICS and is covered in WICEN training.
- **Germany** — The Deutscher Amateur-Radio-Club (DARC) operates Notfunk (emergency radio) training programmes.
- **IARU** — The International Amateur Radio Union provides guidelines for emergency communication that national societies can adapt to their local context.

## Building a personal training plan

A practical progression for a new emergency communicator:

1. **Start with EC-001 and IS-100/IS-700.** These give you the foundational knowledge to be a useful team member.
2. **Attend SKYWARN training** if available in your area.
3. **Check into local emergency nets** regularly to build operating skills.
4. **Participate in a SET or Field Day** to gain hands-on deployment experience.
5. **Learn Winlink** — set up an account and practice sending messages over radio.
6. **Take EC-016 and IS-200** when you're ready to take on more responsibility.
7. **Volunteer for public service events** to get real-world operational experience.
8. **Pursue IS-300/IS-400** if you're moving into leadership roles.

## See also

- [Emergency Communications Overview](/emergency-communications/overview)
- [ARES](/emergency-communications/ares) — ARES training levels and requirements
- [RACES](/emergency-communications/races) — RACES training requirements
- [SKYWARN](/emergency-communications/skywarn) — Severe weather spotter training
- [Emergency Nets](/emergency-communications/emergency-nets) — Net operations skills
- [Go Kit](/emergency-communications/go-kit) — Equipment for deployment
- [Winlink](/digital-modes/winlink) — Digital message handling
- [Field Day](/community/field-day) — Annual emergency preparedness exercise
