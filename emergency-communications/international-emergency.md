---
title: International Emergency Communications
description: Amateur radio emergency communication organizations, regulations, and practices around the world — IARU, RAYNET, WICEN, and regional programmes
published: true
date: 2026-04-05T09:30:00.000Z
tags: emergency, international, iaru, raynet, wicen
editor: markdown
...
### IARU Emergency Telecommunications
...
- Recommending standardized frequencies for emergency communication (the "centre of activity" frequencies)
- Providing a framework for international emergency communication coordination
- Representing amateur radio interests at the International Telecommunication Union (ITU), where global frequency allocations are decided
- Publishing best-practice guidelines for national emergency communication programmes
- Coordinating with international disaster relief organizations

### IARU Region structure
...
## Emergency communication by country and region

### United Kingdom — RAYNET
...
- **Netherlands** — DARES (Dutch Amateur Radio Emergency Service) provides emergency communication support and coordinates with Veiligheidsregio (safety regions)
- **Italy** — ARI (Associazione Radioamatori Italiani) coordinates emergency communication, with active involvement in earthquake response
- **Spain** — URE (Unión de Radioaficionados Españoles) organizes emergency communication volunteers
- **Scandinavia** — Nordic countries maintain amateur radio emergency communication capabilities through their national societies, with particular focus on serving remote and rural areas
- **Switzerland** — USKA (Union Schweizerischer Kurzwellen-Amateure) operates an emergency communication programme integrated with Swiss civil protection

### Developing countries and disaster-prone regions
...
- **Caribbean islands** — Amateur radio provides critical inter-island and island-to-mainland communication during hurricane season. The Hurricane Watch Net on 14.325 MHz is a well-known HF net that activates during Atlantic hurricanes.
- **Pacific islands** — Remote Pacific island nations rely on HF amateur radio for emergency communication, particularly during cyclones and tsunamis.
- **South and Southeast Asia** — Amateur radio provided vital communication during the 2004 Indian Ocean tsunami and subsequent disasters in the region.
- **Central and South America** — Amateur radio emergency communication programmes operate in many Latin American countries, often providing the only long-distance communication capability in rural areas.
...
- **Article 25** recognizes that amateur stations may be used for emergency communication
- **Resolution 640** recommends that administrations facilitate amateur radio emergency communication
- National regulators implement these provisions through their domestic amateur radio regulations

### Cross-border operation during emergencies
...
- **Reciprocal licensing agreements** allow operators licensed in one country to operate in another (see [Reciprocal Licensing](/licensing/reciprocal-licensing))
- **Emergency provisions** in many national regulations allow expanded operating privileges during declared emergencies
- **IARU coordination** helps facilitate international communication during major disasters

## Equipment and modes for international emergency communication
...
### Winlink
[Winlink](/digital-modes/winlink) provides email capability over radio and is used internationally for emergency message traffic. The Winlink network includes radio mail servers (RMS) on multiple continents, supporting both HF and VHF/UHF access.

### APRS
[APRS](/digital-modes/aprs) operates internationally on 144.390 MHz in North America, 144.800 MHz in Europe, and other frequencies in other regions. It provides position tracking and short messaging capability.
...
1. **Join their national emergency communication organization** — ARES, RAYNET, WICEN, Notfunk, or equivalent
2. **Obtain HF operating privileges** — Higher licence classes in most countries grant HF access needed for long-distance communication
3. **Learn Winlink** — International digital message handling capability
4. **Monitor international emergency frequencies** — The IARU centre-of-activity frequencies listed above
5. **Participate in international exercises** — Some IARU regions coordinate cross-border exercises
6. **Obtain reciprocal operating licences** if travelling to countries where you may want to provide emergency communication support

## See also

- [Emergency Communications Overview](/emergency-communications/overview)
- [ARES](/emergency-communications/ares) — US emergency communication programme
- [Disaster Response](/emergency-communications/disaster-response) — Amateur radio in disasters
- [Reciprocal Licensing](/licensing/reciprocal-licensing) — Operating in other countries
- [HF Operating](/operating/hf-operating) — Long-distance radio communication
- [Winlink](/digital-modes/winlink) — Email over radio
- [IARU](/community/iaru) — International Amateur Radio Union
