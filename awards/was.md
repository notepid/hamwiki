...
description: A complete guide to the Worked All States award — confirming contacts with all 50 US states on amateur radio
published: true
date: 2026-04-05T09:30:00.000Z
tags: awards, was, arrl, states
editor: markdown
...
1. **Confirm two-way contacts with stations in all 50 US states.** Each state counts once. The District of Columbia counts as Maryland for WAS purposes.
2. **Use an accepted confirmation method.** The ARRL accepts Logbook of The World (LoTW) electronic confirmations and physical QSL cards verified by an ARRL card checker.
3. **All contacts must be made from the same DXCC entity.** You cannot combine contacts made from different countries.
4. **Contacts must be made from a fixed station location**, unless pursuing the mobile or portable endorsement.
...
## Award Variants and Endorsements
...
**WAS via satellite** — All contacts must be made through amateur radio satellites. This is a rare and difficult endorsement. See [Amateur Satellites](/satellites/amateur-satellites) for more on satellite operations.
...
- **Monitor spotting networks** for stations in states you need. Set up alerts in your logging software.
- **Participate in state QSO parties.** Many states hold annual QSO party events where operators across the state make a concentrated effort to be on the air. These events are purpose-built for WAS chasers.
- **Work contests.** Events like the [ARRL Sweepstakes](/contesting/major-contests) and NAQP are domestic contests where the exchange includes the state or section.
- **Try different bands and times.** If you cannot work a particular state on 20 metres during the day, try 40 metres in the evening.
- **Ask on the air.** If you are close to WAS and need one or two specific states, mention it during QSOs. Operators are often happy to arrange contacts or point you toward someone in a needed state.
...
For portable and mobile stations, the state where the station is physically operating at the time of the contact is what counts. This is why events like state QSO parties, Field Day, and [POTA](/awards/pota) activations are valuable — they put operators in states that might otherwise be hard to find on the air.
...
- [HF Operating](/operating/hf-operating) — Getting on the HF bands
- [HF Propagation](/propagation/hf-propagation) — How signals travel on HF
- [Major Contests](/contesting/major-contests) — Contests that help WAS progress
