---
title: DXCC — DX Century Club
description: The definitive guide to the DXCC award — amateur radio's most prestigious DX achievement, requiring confirmed contacts with 100 or more countries and territories
published: true
date: 2026-04-05T09:30:00.000Z
tags: awards, dxcc, dx, arrl
editor: markdown
...
- It is a sovereign nation recognized by the United Nations.
- It is a territory or possession that is geographically separated from its parent country (by at least a defined distance or body of water).
- It has a distinct ITU callsign block assignment.
- It meets specific geographic separation criteria defined in the DXCC rules.
...
1. **Confirm contacts with at least 100 current DXCC entities.** Each entity counts once, regardless of how many contacts you have with stations there.
2. **Use an accepted confirmation method.** The ARRL accepts Logbook of The World (LoTW) electronic confirmations and physical QSL cards. Cards must be verified by an ARRL-approved DXCC card checker or submitted directly to the DXCC Desk.
3. **Follow the rules for the specific DXCC award variant.** The basic "Mixed" DXCC allows any combination of modes. Single-mode and single-band awards have additional requirements (see below).
4. **Be a licensed amateur radio operator.** All contacts must be made from locations where you held a valid amateur radio licence.
...
**DXCC Digital** — All contacts must be made using digital modes (FT8, FT4, RTTY, PSK31, etc.). This variant has seen explosive growth since the rise of [FT8](/digital-modes/ft8).
...
**Set up LoTW.** Logbook of The World is the fastest and most convenient way to accumulate confirmed entities. Many DX stations upload to LoTW, and confirmations appear within days rather than the weeks or months that paper QSL cards require. See [QSL Cards](/operating/qsl-cards) for more on confirmation methods.
...
**Work contests.** Major international contests like [CQ World Wide](/contesting/major-contests) bring rare stations on the air. A single contest weekend can add 10 or 20 new entities to your total.

**Be patient with pileups.** When a rare station is on the air, dozens or hundreds of operators may be calling simultaneously. Learning to work pileups — listening to the DX station's pattern, calling at the right moment, and keeping your transmission brief — is a core DX skill. See [DX Operating](/operating/dx-operating) for techniques.
...
Many national amateur radio societies offer their own DX awards as well. See [Other Awards](/awards/other-awards) for examples.
...
- [WAS — Worked All States](/awards/was) — Another major ARRL award
- [WAZ — Worked All Zones](/awards/waz) — The CQ Magazine zone award
- [DX Operating](/operating/dx-operating) — Techniques for working DX
- [HF Propagation](/propagation/hf-propagation) — Understanding how HF signals travel
- [Band Conditions](/propagation/band-conditions) — Monitoring propagation
- [Major Contests](/contesting/major-contests) — Contests that bring DX on the air
- [QSL Cards](/operating/qsl-cards) — Confirmation methods
- [Logging](/operating/logging) — Keeping your station log
