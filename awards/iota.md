---
title: IOTA — Islands on the Air
description: A guide to the Islands on the Air program — contacting and activating islands and island groups around the world
published: true
date: 2026-04-05T09:30:00.000Z
tags: awards, iota, islands, rsgb, dx
editor: markdown
...
- **EU-005** — Great Britain (England, Scotland, Wales)
- **NA-085** — Manhattan Island, New York, USA
- **OC-001** — Australia (mainland counts as an island for IOTA)
- **AF-032** — Canary Islands
- **SA-008** — Isla de Margarita, Venezuela
- **AS-007** — Japan (main islands)
- **AN-016** — South Georgia
...
1. **Contact stations on qualifying IOTA island groups.** Each group counts once — you need one confirmed contact with a station on any island within the group.
2. **Use an accepted confirmation method.** IOTA accepts QSL cards verified by an IOTA checkpoint and electronic confirmations through Club Log's IOTA matching system.
3. **Meet the minimum number of groups** for the award level you are applying for.
...
- **IOTA 100** — The basic certificate, requiring 100 confirmed groups.
- **IOTA 200, 300, 400**, etc. — Endorsements at 100-group intervals.
- **IOTA 750** — The highest numbered award, representing an exceptional level of achievement.
- **Plaque of Excellence** — Available at 750 groups and considered the pinnacle of the IOTA program.
- **Continental awards** — Separate awards for working a specific number of groups within a single continent (e.g., all available groups in Europe or Oceania).

## Finding IOTA Stations
...
- The operator must be physically located on a qualifying island.
- All contacts must be logged with the IOTA group reference.
- Logs should be uploaded to Club Log for electronic confirmation matching.
- DXpedition-style activations to rare groups are encouraged and often coordinated with the IOTA programme.
...
## Club Log and Electronic Confirmation
...
IOTA and [DXCC](/awards/dxcc) overlap but measure different things:

- **DXCC** counts countries and territories. A country like the United States is a single DXCC entity, regardless of which US island you contact.
- **IOTA** counts island groups. The US mainland does not count for IOTA at all, but Hawaii (OC-019), Guam (OC-026), and other US island territories each count as separate IOTA groups.
...
- [POTA — Parks on the Air](/awards/pota) — Operating from parks
- [SOTA — Summits on the Air](/awards/sota) — Operating from summits
- [DX Operating](/operating/dx-operating) — Techniques for working distant stations
- [Portable Operating](/operating/portable-operating) — Operating away from home
