---
title: Other Awards Programs
description: A survey of additional amateur radio awards beyond the major programs — national society awards, grid chasing, county hunting, QRP achievements, and more
published: true
date: 2026-04-05T09:30:00.000Z
tags: awards, certificates, arrl, rsgb, darc
editor: markdown
...
**Fred Fish Memorial Award** — Recognizes operators who achieve [VUCC](/awards/vucc) on 50 MHz and at least four additional bands. Named after Fred Fish, W5FF, a pioneering VHF operator.
...
CQ Communications sponsors several well-known awards in addition to [WAZ](/awards/waz):
...
**CQ WPX Award** — Based on the number of different callsign prefixes confirmed. This pairs naturally with participation in the [CQ WPX Contest](/contesting/major-contests).
...
**RSGB Awards (United Kingdom)** — The Radio Society of Great Britain offers awards including Commonwealth Century Club (contacts with 100+ Commonwealth countries), Islands on the Air (see [IOTA](/awards/iota)), and various VHF/UHF achievement certificates.

**DARC Awards (Germany)** — The Deutscher Amateur Radio Club offers the Europa Diplom (contacts with European countries), DLD (Diplom für Deutsche Landkreise — German counties), and the Worked All Europe award associated with the [WAE Contest](/contesting/major-contests).
...
Beyond [VUCC](/awards/vucc), several grid-square-based awards exist:

**FFMA — Fred Fish Memorial Award** — As mentioned above, this ARRL award recognizes multi-band VHF grid-square achievement.

**Grid chasing on FT8/FT4** — While not a formal award program, many digital-mode operators track the number of Maidenhead grid squares they have contacted on HF using [FT8](/digital-modes/ft8) and [FT4](/digital-modes/ft4). Some logging software and online platforms provide grid maps and statistics. The popularity of weak-signal digital modes has made grid chasing accessible even on bands where it was previously impractical.
...
QRP awards are particularly appealing to operators who enjoy building their own equipment or operating with minimal power from portable locations. There is natural overlap with [SOTA](/awards/sota) and [POTA](/awards/pota), where lightweight QRP rigs are the norm.
...
**DMR awards** — Various [DMR](/digital-modes/dmr) networks and organisations offer awards for contacts through DMR repeaters and talkgroups.
...
See [Major Contests](/contesting/major-contests) and [Getting Started with Contesting](/contesting/getting-started-contesting) for more on contest participation.

## Special Event and Themed Awards

Numerous organisations issue awards tied to specific events, themes, or time periods:

- **13 Colonies special event** — An annual July event in the US where operators contact stations representing the original 13 colonies plus bonus stations.
- **Jamboree on the Air (JOTA)** — A global Scouting event where scouts make amateur radio contacts. Special awards are issued.
- **Museum Ships Weekend** — Operators set up stations aboard historic naval vessels and issue contacts to chasers.
- **Historical and commemorative events** — Various clubs and societies issue awards tied to anniversaries, historical events, or memorial operations.
...
- **Your national amateur radio society's website** — Most societies list their available awards prominently.
- **CQ Magazine and other amateur radio publications** — Regularly feature award programs and updates.
- **Online award directories** — Several websites catalogue amateur radio awards from around the world.
- **Club and contest websites** — Many clubs and contest organisations offer their own awards.
- **Social media and forums** — Fellow operators are often happy to share their favourite awards and tips for pursuing them.

## Where to Go Next

- [Awards Overview](/awards/overview) — Introduction to the awards section
- [DXCC — DX Century Club](/awards/dxcc) — The premier DX award
- [WAS — Worked All States](/awards/was) — Working all 50 US states
- [WAZ — Worked All Zones](/awards/waz) — Working all 40 CQ Zones
- [VUCC — VHF/UHF Century Club](/awards/vucc) — Grid-square award for VHF+
- [POTA — Parks on the Air](/awards/pota) — Park activation program
- [SOTA — Summits on the Air](/awards/sota) — Summit activation program
- [IOTA — Islands on the Air](/awards/iota) — Island operating program
- [Major Contests](/contesting/major-contests) — Contests and their awards
- [QSL Cards](/operating/qsl-cards) — Confirmation methods for awards
