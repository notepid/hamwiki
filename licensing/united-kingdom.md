---
title: United Kingdom (Ofcom)
description: UK amateur radio licensing — Foundation, Intermediate, and Full licences
published: true
date: 2026-04-05T09:30:00.000Z
tags: licensing, uk, ofcom
editor: markdown
...
Amateur radio in the United Kingdom is regulated by **Ofcom** (the Office of Communications). The **Radio Society of Great Britain (RSGB)** plays a central role in administering examinations and supporting the amateur radio community on behalf of Ofcom.
...
**Privileges:**
- Maximum transmitter output power of 10 watts
- Access to most amateur bands (HF, VHF, UHF)
- All modes (SSB, CW, FM, digital)
- Callsign prefix: **M7** (e.g., M7ABC)

The Foundation licence provides enough power and frequency access for local VHF/UHF communication and basic HF work, especially with efficient antennas and [digital modes](/digital-modes/overview) like [FT8](/digital-modes/ft8).
...
- Maximum transmitter output power of 50 watts
- Permission to build and modify transmitting equipment
- Callsign prefix: **2E0** (England), **2M0** (Scotland), **2W0** (Wales), **2I0** (Northern Ireland)
...
**Additional privileges:**
- Maximum transmitter output power of 400 watts (1,000 watts on some bands with a Notice of Variation)
- Access to all UK amateur allocations
- CEPT/HAREC reciprocal operating recognition
- Callsign prefix: **M0** (England), **MM0** (Scotland), **MW0** (Wales), **MI0** (Northern Ireland)

## Examination process

### RSGB examination system
...
The UK removed the Morse code requirement in 2003. [CW](/operating/cw-morse-code) remains a popular mode, but it is not assessed in any current UK exam.
...
For more on callsign formats, see the [Callsign Structure](/licensing/callsign-structure) page.

## Key regulations

UK amateur radio is governed by the terms of the individual licence issued by Ofcom. Key points include:

- **Station identification:** Operators must give their callsign at the start and end of each contact, and at regular intervals during longer contacts.
- **Power limits:** Vary by licence level (10W Foundation, 50W Intermediate, 400W Full). Some bands have additional restrictions.
- **EMC considerations:** Operators have a responsibility to ensure their transmissions do not cause undue interference to other radio services or electronic equipment.
- **No broadcasting or commercial use:** Standard amateur radio restrictions apply.
- **Unattended operation:** Permitted for some modes (e.g., digital, beacons) under specific conditions.
- **Special event callsigns:** The RSGB can issue special callsigns for events, anniversaries, and other occasions (e.g., GB-prefix calls).
...
- [Licensing Overview](/licensing/overview) — General introduction to amateur radio licensing
- [Europe (CEPT)](/licensing/europe) — The CEPT/HAREC system and how UK licences fit in
- [Band Privileges](/licensing/band-privileges) — Frequency access by licence class
- [Callsign Structure](/licensing/callsign-structure) — Understanding callsign formats
- [Reciprocal Licensing](/licensing/reciprocal-licensing) — Operating abroad with a UK licence
