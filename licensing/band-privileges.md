---
title: Band Privileges by License Class
description: Which frequency bands and modes are available at each license level
published: true
date: 2026-04-05T09:30:00.000Z
tags: licensing, bands, reference, privileges
editor: markdown
...
- **HF bands** (high frequency, 1.8–30 MHz) — used for long-distance communication via [ionospheric propagation](/propagation/hf-propagation). These are the bands where you can talk around the world.
- **VHF/UHF and above** (30 MHz and up) — used primarily for local and regional communication, including [repeaters](/operating/repeaters), [satellites](/satellites/overview), and line-of-sight contacts.
...
All UK licence levels provide some HF access, which means even Foundation licence holders can make worldwide contacts — particularly using digital modes like [FT8](/digital-modes/ft8) at low power. Specific frequency segments may be restricted at Foundation and Intermediate levels.
...
When operating in another country under [CEPT reciprocal licensing](/licensing/reciprocal-licensing), the host country's power limits apply.

## Comparing entry-level privileges
...
- [Licensing Overview](/licensing/overview) — How licensing works
- [HF Operating](/operating/hf-operating) — Making the most of your HF privileges
- [VHF/UHF Operating](/operating/vhf-uhf-operating) — Getting started on the local bands
- [Propagation Overview](/propagation/overview) — How signals travel on different bands
- [Equipment Overview](/equipment/overview) — Choosing radios for the bands you can use
