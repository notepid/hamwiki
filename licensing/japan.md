---
title: Japan (MIC)
description: Japanese amateur radio licensing system
published: true
date: 2026-04-05T09:30:00.000Z
tags: licensing, japan
editor: markdown
...
**Privileges:**
- Maximum power of 20 watts on HF and 20 watts on VHF/UHF
- Access to selected amateur bands
- CW, phone (voice), and digital modes
- Most operators use VHF/UHF FM and local [repeaters](/operating/repeaters)
...
- Broader HF band access
- Access to modes and frequencies not available at 4th class
...
- More advanced technical knowledge required
...
**Additional privileges:**
- Maximum power of 1,000 watts (with appropriate station licence)
- Full access to all amateur bands and modes
- Recognised for CEPT reciprocal operating purposes
...
### Exams for foreign nationals

Japan offers a limited-scope English-language exam for the 4th class licence, though availability can vary. Foreign visitors can also operate in Japan under reciprocal licensing agreements (see [Reciprocal Licensing](/licensing/reciprocal-licensing)).
...
For more on callsign formats worldwide, see the [Callsign Structure](/licensing/callsign-structure) page.

## Key regulations

Japanese amateur radio regulations are based on the Radio Law (電波法, Denpa-hō) and related ordinances. Key points include:

- **Station identification:** Operators must identify with their callsign at the beginning and end of contacts and at regular intervals.
- **Power limits:** Strictly tied to licence class (20W, 50W, 200W, or 1,000W).
- **Equipment approval:** Transmitting equipment must be either type-approved or inspected. Home-built transmitters require inspection.
- **Frequency allocations:** Japan's amateur band allocations follow ITU Region 3 with some Japan-specific variations.
- **No commercial use or broadcasting:** Standard amateur radio restrictions apply.
- **QSL bureau:** JARL (Japan Amateur Radio League) operates an active QSL bureau for exchanging [QSL cards](/operating/qsl-cards).
...
- [Reciprocal Licensing](/licensing/reciprocal-licensing) — Operating in Japan with a foreign licence
