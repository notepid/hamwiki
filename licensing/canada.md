---
title: Canada (ISED)
description: Canadian amateur radio licensing — Basic and Advanced qualifications
published: true
date: 2026-04-05T09:30:00.000Z
tags: licensing, canada, ised
editor: markdown
...
- Operating on VHF and UHF bands (50 MHz and above)
- Maximum 250 watts on VHF/UHF
- Access to local [repeaters](/operating/repeaters), [satellites](/satellites/overview), and VHF/UHF digital modes

**Additional privileges with 80% or higher:**
- Full HF operating privileges (all amateur bands below 50 MHz)
- Maximum 1,000 watts PEP on HF (with some band-specific exceptions)
- The ability to build and operate home-built transmitters
...
- Maximum power output of 1,000 watts on all bands (HF, VHF, UHF)
- Eligibility for shorter vanity callsigns
- Authorization to act as an examiner for Basic qualification candidates
...
Holders of the Advanced qualification may apply for shorter callsign formats. For more on callsign formats, see the [Callsign Structure](/licensing/callsign-structure) page.

## Key regulations

Canadian amateur radio regulations share many similarities with the US but have some notable differences:

- **Station identification:** Operators must identify with their callsign at the beginning and end of a communication, and at least every 30 minutes during a contact (compared to every 10 minutes in the US).
- **Power limits:** Maximum power depends on qualification level and exam score (see above).
- **No broadcasting:** As in other countries, amateur radio may not be used for broadcasting or commercial purposes.
- **Third-party traffic:** Canada permits third-party traffic with countries that have appropriate agreements.
- **Frequency coordinator:** In many provinces, local frequency coordinators manage repeater and auxiliary station frequencies.
...
- **Radio Amateurs of Canada (RAC)** study guides and courses
- **hamstudy.org** — includes Canadian question pools
- **ExHAMiner** — software for Canadian amateur radio exam practice
- Local club study sessions and mentoring programmes
...
- [United States](/licensing/united-states) — US licensing (useful comparison for Canadian operators)
