---
title: United States (FCC)
description: US amateur radio licensing under FCC Part 97 — Technician, General, and Amateur Extra classes
published: true
date: 2026-04-05T09:30:00.000Z
tags: licensing, fcc, usa
editor: markdown
...
Amateur radio in the United States is regulated by the **Federal Communications Commission (FCC)** under Part 97 of Title 47 of the Code of Federal Regulations. The US has one of the largest amateur radio communities in the world, with over 750,000 licensed operators.
...
**Privileges include:**
- Full operating privileges on all amateur bands above 30 MHz (VHF, UHF, and microwave), including voice, digital, and image modes
- Limited HF privileges: CW (Morse code) on portions of the 80m, 40m, and 15m bands, plus CW and SSB voice on a segment of 10m
- Access to local and regional repeaters, satellites, and digital modes like [FT8](/digital-modes/ft8) and [APRS](/digital-modes/aprs)

The Technician licence is well-suited for operators interested in local communication, [emergency communications](/emergency-communications/overview), [satellite operation](/satellites/overview), and experimenting with VHF/UHF.
...
- Access to substantial portions of all HF bands (160m through 10m) on voice, CW, and digital modes
- The ability to make long-distance (DX) contacts around the world using [HF propagation](/propagation/hf-propagation)

General class operators can work the vast majority of amateur frequencies and participate fully in [DX operating](/operating/dx-operating), [contesting](/contesting/overview), and [award chasing](/awards/overview). For many operators, this is the licence class they hold for their entire ham radio career.
...
**Additional privileges include:**
- Access to all amateur frequencies, including the exclusive "Extra class" sub-bands on HF where some of the rarest DX stations operate
- Eligibility for shorter vanity callsigns (1×2 and 2×1 formats like W1AW or AB2C)

## The examination process

### Volunteer Examiner system
...
- **ARRL VEC** — run by the American Radio Relay League
- **Laurel VEC** — notable for offering exams at no cost
- **W5YI VEC** — another widely used programme
...
The US eliminated the Morse code requirement for all licence classes in 2007. While [CW operation](/operating/cw-morse-code) remains popular and is an excellent mode, it is not tested on any current US exam.

## Licence terms and renewal
...
For more details on callsign formats worldwide, see the [Callsign Structure](/licensing/callsign-structure) page.

## Key regulations

All US amateur radio operators must comply with Part 97 rules. Some key points:

- **Station identification:** You must identify your station with your callsign at least every 10 minutes during a contact and at the end of each communication.
- **No encryption:** Amateur communications must not be encoded for the purpose of obscuring their meaning (with limited exceptions for satellite command stations and certain remote control links).
- **No broadcasting:** Amateur radio is for two-way communication, not one-to-many broadcasting.
- **No commercial use:** The amateur service cannot be used for business purposes or in exchange for payment.
- **Power limits:** The maximum transmitter output power for most amateur stations is 1,500 watts PEP. Lower limits apply on some bands and for some licence classes.
- **Third-party communications:** US amateurs may pass messages on behalf of others (third-party traffic), but only when communicating with stations in countries that have a third-party traffic agreement with the US.
...
- [How to Get Licensed](/getting-started/how-to-get-licensed) — Step-by-step guide for newcomers
- [Band Privileges](/licensing/band-privileges) — What frequencies each licence class can use
- [Callsign Structure](/licensing/callsign-structure) — Understanding callsign formats
- [Reciprocal Licensing](/licensing/reciprocal-licensing) — Operating in other countries with a US licence
