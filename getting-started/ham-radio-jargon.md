---
title: Ham Radio Jargon & Terminology
description: A glossary of common ham radio terms, abbreviations, and Q-codes
published: true
...
# Ham Radio Jargon & Terminology

Amateur radio has its own rich vocabulary developed over more than a century of use. This page covers the most common terms, abbreviations, and Q-codes you'll encounter as a new ham.
...
| **Antenna tuner (ATU)** | A device that matches the impedance of an antenna system to the radio's output. See [Antenna Tuners](/equipment/antenna-tuners). |
| **APRS** | Automatic Packet Reporting System — a digital system for position reporting and messaging. See [APRS](/digital-modes/aprs). |
| **Balun** | A device that converts between balanced and unbalanced signals, typically used between feedline and antenna. See [Baluns and Ununs](/antennas/baluns-and-ununs). |
...
| **Callsign** | Your unique identifier as a licensed amateur radio operator. See [Callsign Structure](/licensing/callsign-structure). |
| **Coax** | Short for [coaxial cable](/equipment/coaxial-cable) — the most common type of feedline. |
...
| **CW** | Continuous Wave — Morse code communication. See [CW / Morse Code](/operating/cw-morse-code). |
...
| **Dipole** | A simple and effective antenna consisting of two elements. See [Dipole Antennas](/antennas/dipole). |
...
| **EME** | Earth-Moon-Earth communication, also known as moonbounce. See [EME / Moonbounce](/satellites/eme-moonbounce). |
| **Feedline** | The cable connecting a radio to an antenna. See [Feedlines](/antennas/feedlines). |
| **Field Day** | An annual emergency preparedness exercise and amateur radio event. See [Field Day](/community/field-day). |
...
| **Hamfest** | An amateur radio gathering, typically including equipment swap meets, seminars, and social events. See [Hamfests](/community/hamfests). |
| **Handie-Talkie (HT)** | A handheld VHF/UHF transceiver. See [Handheld Radios](/equipment/handheld-radios). |
...
| **Net** | An organized on-air meeting on a specific frequency at a scheduled time. See [Net Operations](/operating/net-operations). |
...
| **QSL card** | A written confirmation of a radio contact, traditionally sent as a postcard. See [QSL Cards](/operating/qsl-cards). |
...
| **Repeater** | A station that receives signals on one frequency and retransmits them on another, extending range. See [Repeaters](/operating/repeaters). |
...
| **Simplex** | Communication directly between two stations on the same frequency without a repeater. See [Simplex](/operating/simplex). |
| **SSB** | Single Sideband — the most common voice mode on HF. See [Voice Modes](/operating/voice-modes). |
| **SWR** | Standing Wave Ratio — a measure of how well an antenna is matched to its feedline. See [SWR and Matching](/antennas/swr-and-matching). |
...
- [NATO Phonetic Alphabet](/getting-started/phonetic-alphabet)
- [QSO Basics](/operating/qso-basics)
- [Making Your First Contact](/getting-started/making-your-first-contact)
