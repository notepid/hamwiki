...
description: How to evaluate, test, and buy used amateur radio equipment — what to look for and what to avoid
published: true
date: 2026-04-05T09:30:00.000Z
tags: equipment, buying, used
editor: markdown
...
### eBay and general auction sites
...
### Estate sales and silent key sales
...
### Worn potentiometers and encoders
...
## Testing Equipment You Should Own

To properly evaluate used equipment, having your own basic test gear is invaluable. A digital multimeter, an SWR/power meter, and a dummy load are the essentials. An antenna analyser or NanoVNA is extremely helpful for verifying antenna port impedance. See [Test Equipment](/equipment/test-equipment) for recommendations.

## Buying Vintage and Collectible Equipment
