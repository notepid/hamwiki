---
title: Handheld Radios (HTs)
description: Portable handheld transceivers for VHF/UHF — features, selection, and practical tips
published: true
date: 2026-04-05T09:30:00.000Z
tags: equipment, handheld, ht, portable
editor: markdown
...
- **High** — 5–8 watts (some models reach 10 W)
- **Medium** — 2–3 watts
- **Low** — 0.5–1 watt
...
- **Quarter-wave whip** (roughly 19 cm for 2 m) — better gain than a rubber duck, still pocket-friendly
- **Half-wave whip** (roughly 38 cm for 2 m) — more gain, does not require a ground plane
- **Dual-band gain antennas** (such as the Nagoya NA-771 and Diamond SRH77CA) — popular aftermarket choices that offer a noticeable improvement over the stock antenna
...
- **DMR** — many affordable Chinese HTs (Anytone AT-D878UV, TYT MD-UV390, Radioddity GD-77) support DMR, allowing access to the extensive DMR repeater network and worldwide talk groups via the internet. See [DMR](/digital-modes/dmr).
- **D-STAR** — Icom HTs like the ID-52A and ID-51A Plus 2 support D-STAR for digital voice and data. See [D-STAR](/digital-modes/dstar).
- **System Fusion (C4FM)** — Yaesu HTs like the FT-5DR and FT-70DR support C4FM digital voice. See [System Fusion](/digital-modes/system-fusion).
...
Some HTs include built-in GPS and a TNC for **APRS** (Automatic Packet Reporting System) — transmitting your position, receiving nearby stations, and exchanging short messages. The Yaesu FT-5DR, Kenwood TH-D75A, and Anytone AT-D878UV II Plus are examples with APRS capability. See [APRS](/digital-modes/aprs).
...
### Multi-mode and all-band portables
...
- **Manufacturer software** — each brand offers software for their models, sometimes free, sometimes paid
- **CHIRP** — a free, open-source program that supports a wide range of HTs from many manufacturers. CHIRP lets you programme frequencies, tones, power levels, and labels from a spreadsheet-like interface and upload them to the radio via a programming cable
...
- **Extended battery pack** — more capacity for longer operating
- **AA battery case** — emergency backup power using standard batteries
- **Belt clip or holster** — keeps the radio secure and accessible
- **Car adapter / charging cradle** — charges the radio or powers it from vehicle 12 V
- **Programming cable** — for computer-based channel programming
- **SMA/BNC adapter** — lets you connect an external antenna (for example, a mag-mount on a car roof) for better range
