---
title: Contesting Overview
description: An introduction to amateur radio contesting — competitive on-air events where operators make as many contacts as possible within a set time
published: true
date: 2026-04-05T17:20:24.145Z
tags: 
editor: markdown
dateCreated: 2026-04-05T17:20:24.145Z
---
...
**Working new entities and awards.** Major contests put rare DX stations on the air specifically to hand out contacts. Events like CQ World Wide DX are some of the best opportunities to work new [DXCC entities](/awards/dxcc), states, or grid squares toward [awards](/awards/overview).
...
- **Signal report** — Often a formulaic 59 or 599 (see [QSO Basics](/operating/qso-basics) for how signal reports work).
- **Location identifier** — CQ Zone, ITU Zone, state, province, county, or grid square, depending on the contest.
- **Serial number** — A sequential number incremented with each contact.
- **Contest-specific data** — Some events include age, licence class, power level, or a member number.
...
- **SSB (phone)** — Voice contacts on single sideband.
- **CW** — Morse code, generally the fastest mode for contesting.
- **RTTY / Digital** — Teletype and newer digital modes like FT4, which is specifically designed for contest-style exchanges.
- **Mixed** — Some contests allow any mode and award bonus points for working the same station on multiple modes.

## The Contest Experience

A contest weekend follows a recognisable rhythm. When the starting time arrives, the bands erupt with activity. Operators call CQ on a clear frequency (**running**) or tune across the band looking for new stations to work (**search and pounce**). Activity peaks during the best [propagation](/propagation/overview) windows and quiets down during the small hours.
...
## Contesting Culture and Etiquette
...
See [Getting Started with Contesting](/contesting/getting-started-contesting) for a practical step-by-step guide to entering your first event.

## Where to Go Next

- [Getting Started with Contesting](/contesting/getting-started-contesting) — A beginner's guide to your first contest
- [Major Contests](/contesting/major-contests) — The big events on the amateur radio calendar
...
- [Contest Logging](/contesting/contest-logging) — Software and procedures for contest logging
