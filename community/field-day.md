---
title: Field Day
description: The annual Field Day event — amateur radio's biggest on-air operating event, combining emergency preparedness, portable operation, and community fun
published: true
date: 2026-04-05T09:30:00.000Z
tags: community, field-day, events, operating, emergency-communications, portable
editor: markdown
...
Field Day is the largest annual on-air operating event in amateur radio. Organized by the [ARRL](/community/arrl) in the United States and by similar national societies in other countries, Field Day combines emergency communications preparedness with competitive operating and community fun. Each year, thousands of amateur radio groups set up temporary stations in parks, fields, parking lots, and other outdoor locations, then spend 24 hours making as many contacts as possible using portable equipment and emergency power.
...
Other countries hold their own Field Day events at different times of the year. For example, the [RSGB](/community/rsgb) in the United Kingdom holds its National Field Day in June as well, while Australia's WIA holds field day events at various times suited to the southern hemisphere calendar.
...
- **Class A** — Club or group portable stations operating from a location away from home, using emergency power (generators, batteries, solar). This is the most popular category and reflects the core Field Day concept.
- **Class B** — One or two operators using emergency power in a portable setting. Suited to smaller groups or individuals who want the portable experience.
- **Class C** — Mobile stations operating from vehicles.
- **Class D** — Home stations using commercial power. This allows operators who cannot go to a field location to participate from their home shack.
- **Class E** — Home stations using emergency power. Operators set up at home but run on generators or batteries.
- **Class F** — Stations operating from an established Emergency Operations Center (EOC).
...
## Setting Up a Field Day Station
...
- **United Kingdom** — The RSGB National Field Day and SSB Field Day are competitive events where groups operate portable stations and contest for points.
- **Germany** — DARC sponsors field day events as part of its contest programme.
- **Australia** — The WIA and affiliated clubs hold field days and portable operating events.
- **Canada** — Canadian amateurs participate in ARRL Field Day alongside their US counterparts, with RAC sections included in the exchange.
...
- [ARRL](/community/arrl)
- [Portable & Mobile Operating](/operating/portable-mobile)
