...
description: How to find and join amateur radio clubs, what to expect from club membership, and an overview of specialty organizations
published: true
date: 2026-04-05T09:30:00.000Z
tags: community, clubs, organizations, elmers
editor: markdown
...
- **ARRL Club Search** — The [ARRL](/community/arrl) maintains a searchable database of affiliated clubs in the United States.
- **RSGB Club Finder** — The [RSGB](/community/rsgb) lists affiliated clubs across the United Kingdom.
- **RAC Club Directory** — Radio Amateurs of Canada maintains a list of Canadian clubs.
- **DARC Ortsverbände** — The German amateur radio club (DARC) lists its local chapters (Ortsverbände) on its website.
- **National society websites** — Most national amateur radio societies maintain a club directory. Check the website for the society in your country.
...
Attending a [hamfest](/community/hamfests) or amateur radio convention is an excellent way to meet local hams and learn about clubs in your region. Many clubs have tables or booths at hamfests where they recruit new members and share information about their activities.
...
- **AMSAT** — The Radio Amateur Satellite Corporation, which supports amateur satellite development and operation. See [Satellites](/satellites/overview).
- **TAPR** — Tucson Amateur Packet Radio, focused on digital communications and networking.
- **QCWA** — The Quarter Century Wireless Association, for amateurs who have held a licence for 25 or more years.
- **YLRL** — Young Ladies' Radio League, supporting women in amateur radio.
- **FISTS** — An international CW (Morse code) operating club promoting the use of CW.
- **SOTA** — Summits on the Air, an award programme and community for operators who hike to mountain summits and make radio contacts. See [Awards](/awards/overview).
- **POTA** — Parks on the Air, a programme encouraging portable operation from parks and public lands.
...
- [Hamfests & Conventions](/community/hamfests)
- [Field Day](/community/field-day)
- [Online Communities](/community/online-communities)
- [Youth in Ham Radio](/community/youth-in-ham-radio)
