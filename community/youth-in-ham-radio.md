---
title: Youth in Ham Radio
description: Programs, organizations, and resources for introducing young people to amateur radio, electronics, and wireless communications
published: true
date: 2026-04-05T09:30:00.000Z
tags: community, youth, education, stem, schools, scouting
editor: markdown
...
## Why Ham Radio for Young People?
...
- **ARRL Teachers Institute on Wireless Technology** — A professional development programme that trains schoolteachers to incorporate amateur radio and electronics into their STEM curricula. Participants receive equipment and lesson plans to use in their classrooms.
- **ARRL Education & Technology Program** — Provides resources, grants, and support for amateur radio activities in schools, including school club stations.
- **RSGB Schools Programme** — The RSGB works with schools in the United Kingdom to introduce students to amateur radio through special event stations, demonstrations, and training leading to the Foundation licence.
- **Youth on the Air (YOTA)** — An IARU Region 1 initiative that organizes annual summer camps where young amateurs from across Europe and beyond come together for a week of operating, learning, and social activities. YOTA also runs a December event encouraging young operators worldwide to get on the air.

### Scouting and Youth Organizations

Amateur radio has a natural connection with scouting and similar youth organizations:

- **Jamboree on the Air (JOTA)** — Organized by the World Organization of the Scout Movement (WOSM), JOTA is an annual event held on the third full weekend of October. Scouts around the world visit amateur radio stations and make contacts with other Scout groups, experiencing radio communication firsthand. JOTA is one of the largest events in scouting, with hundreds of thousands of participants each year.
- **Jamboree on the Internet (JOTI)** — A companion event to JOTA, using internet-based communication tools to connect Scouts worldwide.
- **Radio merit badges and awards** — Scouting programmes in many countries offer merit badges or proficiency awards related to radio and electronics, which can be earned with the help of local amateur radio clubs and operators.
...
- **Youth Roundup** — Operating events specifically targeting young participants.
- **Youth DX Adventure** — Programmes that take young operators to exotic locations for DXpedition-style operating.
- **School Club Roundup** — An ARRL-sponsored event encouraging school radio clubs to make contacts.
...
**Involve local clubs.** Local amateur radio clubs can provide access to equipment, stations, and experienced operators. Many clubs are eager to support youth programmes and will welcome young visitors and new members. See [Clubs & Organizations](/community/clubs-and-organizations).
...
- [Getting Started — What Is Amateur Radio?](/getting-started/what-is-amateur-radio)
- [Getting Started — How to Get Licensed](/getting-started/how-to-get-licensed)
