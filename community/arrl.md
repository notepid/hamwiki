---
title: ARRL — The American Radio Relay League
description: The national association for amateur radio in the United States, providing advocacy, education, and community resources since 1914
published: true
date: 2026-04-05T09:30:00.000Z
tags: community, arrl, usa, organizations
editor: markdown
...
- **QST** — The ARRL's monthly membership journal, published continuously since 1915. QST contains technical articles, product reviews, operating tips, news, and columns covering all aspects of amateur radio.
- **The ARRL Handbook** — A comprehensive technical reference updated annually, covering electronics theory, radio design, antennas, propagation, digital modes, and more. It is widely regarded as one of the most important references in amateur radio.
- **The ARRL Antenna Book** — A detailed guide to antenna design, construction, and theory.
- **QEX** — A journal focused on advanced experimentation and technical articles.
- **On the Air** — A newer magazine aimed at beginners and newer licensees, with accessible articles on getting started, operating, and equipment.

### Awards & Operating Programs

The ARRL administers some of the most popular award programs in amateur radio, including Worked All States (WAS), DX Century Club (DXCC), and VHF/UHF Century Club (VUCC). These programs give operators goals to work toward and are a major motivator for on-air activity. See the [Awards](/awards/overview) section for more information.
...
While the ARRL is a US-based organization, it is part of the global amateur radio community and works closely with national societies in other countries through the [IARU](/community/iaru). International amateurs are welcome to join as international members.
...
- [IARU — International Amateur Radio Union](/community/iaru)
- [RSGB — Radio Society of Great Britain](/community/rsgb)
- [Clubs & Organizations](/community/clubs-and-organizations)
- [Licensing in the United States](/licensing/united-states)
