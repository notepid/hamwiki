...
description: Forums, social media groups, mailing lists, and online platforms where amateur radio operators connect, learn, and share
published: true
date: 2026-04-05T09:30:00.000Z
tags: community, online, forums, social-media, reddit
editor: markdown
...
The internet has greatly expanded the ways amateur radio operators connect with each other. Online communities complement on-air contacts and local club meetings by providing platforms for discussion, technical help, equipment reviews, project sharing, and social interaction with hams worldwide. Whether you are looking for help with a specific technical problem, want to follow the latest developments in digital modes, or simply enjoy chatting with fellow operators, there is an online community for you.
...
- **r/amateurradio** — The largest ham radio subreddit, with a broad mix of discussion topics including equipment questions, operating experiences, project photos, news, and advice for newcomers.
- **r/HamRadio** — Another general-purpose ham radio community.
- **r/RTLSDR** — Focused on software-defined radio using inexpensive RTL-SDR dongles and related hardware.
- **r/hamfest** — A marketplace-style subreddit for buying, selling, and trading amateur radio equipment.
...
- **Be respectful.** Online communities work best when members treat each other with courtesy, even when they disagree. Amateur radio has a strong tradition of mutual respect, and this should extend to online interactions.
- **Search before asking.** Many questions have been answered before. Checking the forum archives or using the search function can often find the answer you need quickly.
- **Contribute when you can.** Sharing your own experiences, answering questions, and posting project photos all help build a vibrant community.
- **Verify technical information.** Not everything posted online is accurate. Cross-check important technical details with reliable sources such as national society publications, the ARRL Handbook, or manufacturer documentation.

## See Also

- [Community & Resources Overview](/community/overview)
- [Clubs & Organizations](/community/clubs-and-organizations)
- [Further Reading & Resources](/community/further-reading)
