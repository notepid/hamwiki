...
description: Antennas for vehicle-mounted amateur radio — HF mobile whips, VHF/UHF mobile antennas, mounting options, and getting the best performance from your vehicle installation
published: true
date: 2026-04-05T09:30:00.000Z
tags: antennas, mobile, vehicle, hf, vhf, uhf
editor: markdown
...
## Mobile HF performance expectations
...
- **20 metres and above:** Loaded whips are reasonably efficient on these bands. Many operators make contacts worldwide from their vehicles on 20 and 17 metres. Digital modes like [FT8](/digital-modes/ft8) are particularly well suited to mobile operation because they work with weak signals.
- **40 metres:** Usable with a good antenna and installation. Local and regional contacts are readily achievable. DX is possible under good propagation.
- **80 and 160 metres:** Challenging. The severe shortening required results in very low efficiency and narrow bandwidth. Contacts are possible but limited to stronger signals and shorter distances.
...
- **Driving distraction** — Operating a radio while driving requires the same caution as any other activity that divides your attention. Know and comply with your local laws regarding radio use while driving. Many operators only transmit when stopped.
- **Antenna height** — Know the total height of your vehicle plus antenna. HF whips can add 1.5–2.5 metres to the vehicle height. Mark the dashboard with the clearance limit as a reminder.
- **Securing the antenna** — Ensure the antenna and mount are secure. An antenna that comes loose at highway speed is a serious hazard to other motorists.
- **RF exposure** — Keep antennas as far from vehicle occupants as practical. Roof-centre mounts provide the most distance. Avoid mounting HF antennas directly adjacent to passenger windows, especially at higher power levels.

## Where to go next

- [Vertical Antennas](/antennas/vertical) — The theory behind vertical antenna designs
- [Portable Antennas](/antennas/portable-antennas) — Lightweight antennas for field operations
- [VHF/UHF Antennas](/antennas/vhf-uhf-antennas) — More on VHF/UHF antenna options
- [SWR and Matching](/antennas/swr-and-matching) — Tuning and matching your mobile antenna
- [Antenna Fundamentals](/antennas/antenna-fundamentals) — Shortened antennas and efficiency
