...
description: How to find amateur radio contest schedules, plan your contest year, and keep track of upcoming events
published: true
date: 2026-04-05T09:30:00.000Z
tags: contesting, calendar
editor: markdown
...
With hundreds of amateur radio contests held every year, keeping track of what is happening and when can be a challenge. Fortunately, several excellent resources maintain up-to-date contest calendars, and with a little planning you can build a contest schedule that fits your interests and availability.

## Online Contest Calendars
...
- **RAC (Radio Amateurs of Canada)** — Canadian contests and operating events
- **DARC (Deutscher Amateur Radio Club)** — German and European contests including WAE
- **JARL (Japan Amateur Radio League)** — Japanese contests including the All Asia DX Contest
- **WIA (Wireless Institute of Australia)** — Australian and Oceania contests

## Planning Your Contest Year
...
### Monthly overview of major events
...
- Practice contest operating in a relaxed, friendly environment.
- Work toward the Worked All States (WAS) award.
- Meet operators from a specific region.
- Give out contacts if you are in the featured state — you will be the sought-after station.
...
- **ARRL January VHF Contest** — the largest VHF contest in North America.
- **ARRL June VHF Contest** — takes advantage of summer sporadic-E propagation.
- **CQ WW VHF Contest** — a worldwide VHF event in July.
- **ARRL September VHF Contest** — the autumn VHF event.

VHF/UHF contesting involves different propagation modes — [tropospheric ducting](/propagation/tropospheric), [sporadic E](/propagation/sporadic-e), meteor scatter, and moonbounce — and a different set of skills and equipment. The exchange typically includes a [Maidenhead grid square](/operating/grid-squares) rather than a zone or state.

## Integrating Contests into Your Calendar
...
**Track your results.** Keep a simple record of which contests you entered, your score, and any notes about what went well or poorly. Over time, this becomes a valuable reference for improving your performance. See [Contest Logging](/contesting/contest-logging) for more on post-contest analysis.

## Contest Alerts and Notifications
...
- [Contesting Overview](/contesting/overview) — Introduction to amateur radio contesting
- [Getting Started with Contesting](/contesting/getting-started-contesting) — Entering your first contest
- [Major Contests](/contesting/major-contests) — Detailed descriptions of the biggest events
...
- [Awards Overview](/awards/overview) — How contest contacts contribute to awards
