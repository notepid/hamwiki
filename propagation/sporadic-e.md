---
title: Sporadic E Propagation
description: Understanding Sporadic E — how it works, when to expect it, and how to take advantage of it
published: true
date: 2026-04-05T09:30:00.000Z
tags: propagation, sporadic-e, vhf, 6m
editor: markdown
...
Sporadic E (abbreviated Es or Es) is one of the most exciting and dramatic forms of radio propagation. Dense patches of ionization form unexpectedly in the E layer of the [ionosphere](/propagation/ionosphere), at altitudes of roughly 100–120 km (60–75 miles), and reflect radio signals over distances of 1,000–2,000 km per hop. Sporadic E can affect frequencies well into the VHF range — routinely opening the 6-metre (50 MHz) band and occasionally the 2-metre (144 MHz) band — making it a source of great excitement for VHF operators.
...
- Late morning through mid-afternoon (roughly 09:00–16:00 local time) tends to be the most active period.
- A secondary peak sometimes occurs in the evening hours (18:00–22:00 local time).
- Overnight events are less common but do occur.

### Geographic distribution

Sporadic E is observed worldwide, but some regions experience it more frequently:

- Mid-latitudes (roughly 20°–55° N and S) see the most Sporadic E activity.
- The Mediterranean region, Japan, and the southern United States are particularly active areas.
- High latitudes and equatorial regions experience Sporadic E less frequently, and the events tend to be weaker.

## Frequencies affected by Sporadic E
...
## Recognizing Sporadic E openings
...
- **SSB** is the most common mode for Sporadic E contacts on 6 m, especially during strong openings when signals are well above the noise.
- **CW** allows contacts at lower signal levels and can work during weaker openings.
- **FT8** (via [WSJT-X](/software/digital-mode-software)) has become increasingly popular and can detect Es openings at very low signal levels, sometimes before they're strong enough for SSB. The standard 6 m FT8 frequency is 50.313 MHz.
- **MSK144** is designed for very short-duration reflections (meteor scatter), but can also capture brief Es events on 2 m.

### Watch for direction shifts
...
## Sporadic E and amateur radio awards

Sporadic E is a major factor for several VHF-oriented award programs:

- **[VUCC](/awards/vucc)** (VHF/UHF Century Club): Sporadic E on 6 m is the primary way most operators accumulate the grid squares needed for VUCC awards.
- **Fred Fish Memorial Award:** A well-known 6-metre award recognizing operators who confirm contacts in a large number of grid squares, heavily dependent on Sporadic E.
- **WAS (Worked All States) on 6 m:** Sporadic E is essential for reaching many states/provinces that are difficult to work via other modes.

## Further reading

- [VHF/UHF Propagation](/propagation/vhf-propagation) — All propagation modes on VHF and above
- [The Ionosphere](/propagation/ionosphere) — Understanding the E layer
- [HF Propagation](/propagation/hf-propagation) — How Sporadic E affects the upper HF bands
- [Propagation Tools](/propagation/propagation-tools) — Real-time Sporadic E monitoring
