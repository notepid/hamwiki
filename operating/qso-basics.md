---
title: QSO Basics
description: How to make a contact (QSO) on amateur radio, including calling procedures, signal reports, and common exchanges
published: true
date: 2026-04-05T09:30:00.000Z
tags: operating, beginner
editor: markdown
...
A **QSO** is a contact between two (or more) amateur radio stations. The term comes from the Q-code system originally developed for Morse code — QSO literally means "I can communicate with..." Making QSOs is the core activity of amateur radio, and whether your contact lasts thirty seconds or three hours, the basic structure is the same.

## Before You Transmit

The single most important habit in amateur radio is **listen first**. Before pressing the transmit button:

1. **Tune to the frequency** and listen for at least 15–30 seconds.
2. **Ask if the frequency is in use.** On voice, say "Is this frequency in use?" followed by your callsign. On CW, send "QRL?" (meaning "Are you busy?"). If someone responds, move to another frequency.
3. **Check that you are in the correct part of the band.** Band plans designate different segments for different modes. Transmitting CW in the phone (voice) segment, or vice versa, will cause interference and frustration.
...
- Always use the [phonetic alphabet](/getting-started/phonetic-alphabet) for your callsign.
- Keep your CQ short — long CQs lose listeners.
- State your callsign at least once per CQ sequence.
...
- **Signal report** — How well you are receiving the other station (see below).
- **Name** — First name is standard practice.
- **Location** — City, state/province, country, or grid square.

### 2. Conversation (ragchew)
...
- **59** — Perfectly readable and extremely strong. The best voice report.
- **599** — Perfect CW report.
- **55** — Readable and fairly strong. A solid contact.
- **33** — Readable with difficulty and weak. A challenging but successful contact.

In practice, many operators default to giving 59 or 599 reports, especially in [contests](/contesting/overview). While this is common, giving honest signal reports helps other operators assess their station's performance and understand propagation conditions.
...
| QSL | Confirmation of contact (also refers to [QSL cards](/operating/qsl-cards)) |
| QTH | Location/city |
...
For a more comprehensive list, see [Ham Radio Jargon](/getting-started/ham-radio-jargon).

## Calling on a Repeater

Making a contact on a [repeater](/operating/repeaters) is slightly different from HF procedures. Instead of calling CQ, it is common to simply identify yourself and indicate that you are listening:
...
- **Start on a local repeater.** Repeater contacts are straightforward and forgiving. Most local operators are happy to welcome newcomers.
- **Listen to experienced operators.** You will pick up the rhythm and conventions of on-air communication by listening before you transmit.
- **Write down what you want to say.** Having a simple script or notes in front of you removes the pressure of having to remember everything in the moment.
- **Do not worry about mistakes.** Everyone makes them. If you forget to give your callsign or fumble a phonetic, just correct yourself and carry on.
- **Participate in nets.** Organized [nets](/operating/net-operations) offer a structured setting where a net control station guides the proceedings, making it easier to participate.
- **Keep a log.** Recording your contacts helps you track your progress and is required by regulation in some countries. See [Logging](/operating/logging) for options.

## Where to Go Next

- [Voice Modes](/operating/voice-modes) — Understanding FM, SSB, and AM
- [CW / Morse Code](/operating/cw-morse-code) — Getting started with Morse
- [Repeaters](/operating/repeaters) — Making contacts on VHF/UHF repeaters
- [HF Operating](/operating/hf-operating) — Making contacts on the shortwave bands
- [QSL Cards](/operating/qsl-cards) — Confirming your contacts
- [Logging](/operating/logging) — Keeping track of your QSOs
