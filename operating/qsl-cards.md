---
title: QSL Cards
description: Exchanging QSL cards to confirm amateur radio contacts, including paper cards, eQSL, LoTW, and QSL bureaux
published: true
...
A **QSL card** is a written confirmation that a contact (QSO) took place between two amateur radio stations. The term comes from the Q-code "QSL," meaning "I confirm receipt." Exchanging QSL cards has been a tradition in amateur radio since the early days of the hobby, and while the methods have evolved from paper cards to electronic confirmations, the purpose remains the same — to confirm and celebrate contacts.

## Why QSL?

**Awards** — Most [amateur radio awards](/awards/overview) require confirmed contacts. You need QSL confirmations to claim awards like [DXCC](/awards/dxcc), [WAS](/awards/was), [WAZ](/awards/waz), and many others. The method of confirmation (paper card, LoTW, eQSL) accepted varies by award.
...
- **Contact details** — The date, time (in UTC), frequency or band, mode, and signal report of the QSO being confirmed
- **A design** — Many operators design custom cards featuring photographs of their station, local scenery, artwork, or the national flag

### Sending paper QSL cards
...
- **Digital certificates** — LoTW uses a digital certificate system (similar to website SSL certificates) to verify the identity of each station. You must request a certificate and verify your identity before you can upload logs.
- **Upload logs in ADIF format** — Most [logging software](/operating/logging) can export logs in the ADIF format required by LoTW, and many can upload directly.
- **Free to use** — Uploading logs and confirming contacts is free. Applying for awards based on LoTW confirmations has a fee.
- **Widely accepted** — LoTW confirmations are accepted for DXCC, WAS, WAZ, VUCC, and other ARRL-sponsored awards. Many other award programs also accept LoTW.
- **Trusted** — The certificate system makes LoTW confirmations highly trustworthy, which is why they are accepted for major awards.
...
- **Upload logs** in ADIF format. Matching is automatic.
- **Virtual cards** — You can design a QSL card image that is displayed to stations you have confirmed.
- **Authenticity Guaranteed (AG)** status — eQSL offers a verification level where operators confirm their identity. AG-level confirmations are accepted by some (but not all) award programs.
...
- **Log accurately.** The most common reason for QSL mismatches is incorrect dates, times, bands, or modes in the log. Use UTC for all times. Ensure your clock is accurate. See [Logging](/operating/logging).
- **QSL promptly.** Upload electronic logs regularly (many logging programs do this automatically) and respond to paper QSL cards in a timely manner.
- **Check your log against incoming cards.** Before confirming a paper QSL, verify the contact exists in your log and the details match.
- **Keep your address current** on QRZ.com and with your national QSL bureau.
- **For DX QSLing**, check the station's QRZ.com page for their preferred QSL method before sending a card. Some operators are "LoTW only" and will not respond to paper cards.

## Where to Go Next

- [Logging](/operating/logging) — Keeping accurate contact records
- [Awards Overview](/awards/overview) — Awards that require QSL confirmations
- [DXCC](/awards/dxcc) — The most popular DX award
- [DX Operating](/operating/dx-operating) — Making the contacts you will want to confirm
- [QSO Basics](/operating/qso-basics) — Making contacts
