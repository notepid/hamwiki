---
title: CW / Morse Code
description: Operating using Morse code (CW) on the amateur bands, including learning resources and on-air procedures
published: true
date: 2026-04-05T09:30:00.000Z
tags: operating, cw, morse
editor: markdown
...
**Simple equipment** — A CW transmitter can be extremely simple. Some of the most popular [homebrew](/diy-projects/overview) and QRP (low-power) projects are CW transceivers. You can build a working CW radio from a handful of components.
...
- **LCWO.net** (Learn CW Online) — A popular free web-based tool using the Koch method.
- **MorseMachine** — A web-based trainer that simulates on-air contacts.
- **CW Academy** — A structured course offered by the CW Operators' Club (CWops), with volunteer mentors and live practice sessions. Highly recommended.
- **Just Learn Morse Code** — Free Windows software.
- **Morse Trainer apps** — Available for iOS and Android.
- **On-air practice** — The W1AW code practice transmissions (from ARRL headquarters) broadcast at various speeds on HF.
...
- **CQ** — General call
- **DE** — "From"
- **K** — "Go ahead" (inviting a response)
...
Breaking this down:
- **GM** — Good morning
- **OM** — Old man (friendly greeting)
- **TNX FER CALL** — Thanks for the call
- **UR RST** — Your signal report (readability, strength, tone)
- **NAME IS** — Operator's name
- **QTH** — Location
- **HW CPY?** — How copy? (Did you get that?)
...
- **5–10 WPM** — Beginner range. There are operators who will gladly slow down to this speed to help newcomers.
- **12–18 WPM** — Comfortable for casual QSOs and most on-air activity.
- **20–30 WPM** — Experienced operators and common contest speeds.
- **30–50+ WPM** — High-speed operators, often in contests or CW clubs.
...
- **40 metres** — 7.000–7.040 MHz (very active, especially in evenings)
- **30 metres** — 10.100–10.130 MHz (CW and digital only band)
- **20 metres** — 14.000–14.070 MHz (active throughout the day)
- **15 metres** — 21.000–21.070 MHz (good during high solar activity)

On VHF, CW is used for weak-signal work and [EME (moonbounce)](/satellites/eme-moonbounce) contacts, typically in the lowest segments of each band.

## CW Contesting and Awards

CW is featured prominently in many [contests](/contesting/overview) and [awards](/awards/overview). Some contests are CW-only, and many mixed-mode contests have separate CW categories. The speed, efficiency, and narrow bandwidth of CW make it well suited to competitive operating.
...
- [QSO Basics](/operating/qso-basics) — General contact procedures
- [HF Operating](/operating/hf-operating) — Operating on the HF bands where CW is most active
- [DX Operating](/operating/dx-operating) — CW is a powerful mode for DX
- [Contesting Overview](/contesting/overview) — CW in competition
- [DIY Projects](/diy-projects/overview) — Build your own CW transceiver
- [Ham Radio Jargon](/getting-started/ham-radio-jargon) — Abbreviations and terminology
