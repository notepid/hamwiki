---
title: HF Operating
description: Operating on the high-frequency bands (1.8–30 MHz) for long-distance communication
published: true
...
The **HF (High Frequency) bands** — spanning from 1.8 MHz to 30 MHz — are where amateur radio becomes a truly global hobby. Through a phenomenon called [ionospheric propagation](/propagation/ionosphere), HF signals can bounce between the Earth's surface and layers of the ionosphere, travelling hundreds or thousands of kilometres with relatively modest equipment. A 100-watt transceiver and a wire antenna in the back garden can reach the other side of the world when conditions are right.

## The HF Amateur Bands

Amateur operators have access to several allocations within the HF spectrum. Each band has its own character, propagation behaviour, and typical uses. The exact frequency limits vary by country and licence class — check your national [band plan](/licensing/band-privileges) for details.
...
**Solar cycle** — The Sun goes through approximately 11-year cycles of activity. During solar maximum, higher HF bands open up for worldwide communication. During solar minimum, activity on 10 and 15 metres drops significantly, and operators concentrate on the lower bands. See [Propagation](/propagation/overview) for more detail.
...
### Equipment
A basic HF station consists of an HF transceiver, an antenna, a power supply, and feedline. Modern HF transceivers typically cover all amateur bands from 160 to 10 metres and include built-in features like antenna tuners, DSP filtering, and digital mode interfaces. See [Equipment Overview](/equipment/overview) for guidance on choosing a radio.

### Antennas
HF antennas are larger than VHF/UHF antennas because the wavelengths are longer. Common starter antennas include random wire antennas with a tuner, end-fed half-wave antennas, and fan dipoles that cover multiple bands. Even a simple wire antenna can produce excellent results on HF. See [Antennas Overview](/antennas/overview) for options.

### Tuning and Operating

When operating on HF, keep these practices in mind:

- **Listen across the band** before calling CQ. Get a sense of band conditions and activity levels.
- **Use the correct mode for the band segment.** Band plans allocate portions of each band for CW, digital, and phone (voice). Respect these allocations.
- **Call CQ** on a clear frequency after confirming no one is using it. See [QSO Basics](/operating/qso-basics) for the procedure.
- **Use your S-meter and ears** to assess propagation. If you are hearing strong signals from a particular direction or region, that is likely a good path for you to make contacts in.
- **Be patient.** HF propagation changes constantly. A band that sounds dead may open up minutes later.
- **Try different bands and times.** The best band depends on the time of day, season, and solar conditions. Experiment to learn what works.

## HF Operating Activities

The HF bands support a wide variety of operating activities:

- **Ragchewing** — Extended casual conversations, often on 80 and 40 metres.
- **DXing** — Chasing contacts with distant or rare stations. See [DX Operating](/operating/dx-operating).
- **Contesting** — Competitive events where operators make as many contacts as possible. See [Contesting Overview](/contesting/overview).
- **Nets** — Organized on-air groups that meet on fixed frequencies and schedules. See [Net Operations](/operating/net-operations).
- **Award chasing** — Working toward achievements like [DXCC](/awards/dxcc), [WAS](/awards/was), and [WAZ](/awards/waz).
- **QRP** — Low-power operating (5 watts or less on CW, 10 watts on SSB), which adds challenge and rewards skill and patience.
- **Digital modes** — [FT8](/digital-modes/ft8), [PSK31](/digital-modes/psk31), [RTTY](/digital-modes/rtty), and other modes are very active on HF.
- **CW** — Morse code remains popular on all HF bands. See [CW / Morse Code](/operating/cw-morse-code).

## Split Operating

When working a rare [DX station](/operating/dx-operating), you will frequently encounter **split operating**. The DX station transmits on one frequency but listens on a different frequency (or range of frequencies). This prevents the pileup of calling stations from covering up the DX station's signal.
...
- [DX Operating](/operating/dx-operating) — Working distant stations
- [Voice Modes](/operating/voice-modes) — SSB and AM on HF
- [CW / Morse Code](/operating/cw-morse-code) — Operating with Morse code
- [Propagation Overview](/propagation/overview) — Understanding how HF signals travel
- [Antennas Overview](/antennas/overview) — HF antenna options
- [QSO Basics](/operating/qso-basics) — Making your first contact
