...
description: Amateur radio in space — satellites, the ISS, moonbounce, meteor scatter, and beyond
published: true
date: 2026-04-05T17:34:08.482Z
tags: 
editor: markdown
dateCreated: 2026-04-05T17:34:08.482Z
---
...
## What makes space communication special?
...
The amateur satellite programme is one of the oldest non-governmental space efforts in the world. Dozens of [amateur satellites](/satellites/amateur-satellites) are in orbit at any given time, providing FM repeaters in space, linear transponders for SSB and CW, digital store-and-forward systems, and experimental payloads. Organizations like AMSAT coordinate the construction and launch of these spacecraft.

### ISS contacts

The International Space Station carries amateur radio equipment that crew members use to make contacts with operators on the ground, and for scheduled educational outreach events with schools. [Making contact with the ISS](/satellites/iss-contacts) is one of the most accessible and thrilling space-related activities in amateur radio.

### Satellite tracking

Working satellites requires knowing when they will be visible from your location and where to point your antenna. [Satellite tracking](/satellites/satellite-tracking) covers the software, tools, and techniques for predicting passes and following a satellite across the sky in real time.

### Satellite station equipment

While some satellite contacts can be made with a handheld radio, a dedicated [satellite station](/satellites/satellite-equipment) typically includes directional antennas (often a Yagi or crossed-Yagi), an azimuth/elevation rotator, a dual-band transceiver, and software for Doppler correction. The requirements vary significantly depending on which satellites you want to work.

### EME (Moonbounce)

[Earth-Moon-Earth (EME)](/satellites/eme-moonbounce) communication is among the most technically demanding activities in amateur radio. Operators transmit a signal toward the Moon and listen for the extremely faint echo roughly 2.5 seconds later. Path losses exceed 250 dB, requiring large antennas and sensitive receivers. Despite the difficulty, EME contacts are made regularly on bands from 144 MHz through microwave frequencies.

### Meteor scatter

[Meteor scatter](/satellites/meteor-scatter) communication uses the ionized trails left by meteors entering the Earth's atmosphere to reflect VHF signals far beyond their normal line-of-sight range. Contacts are often brief — sometimes only a few seconds — making digital modes like MSK144 particularly well suited to this mode. Meteor scatter works on the 6-metre and 2-metre bands and is most productive during major annual meteor showers.

## Getting started with space communication
...
- [Amateur Radio Satellites](/satellites/amateur-satellites) — Active satellites and how to use them
- [ISS Contacts](/satellites/iss-contacts) — Talking to astronauts on the International Space Station
- [Satellite Tracking](/satellites/satellite-tracking) — Predicting passes and following satellites across the sky
- [Satellite Station Equipment](/satellites/satellite-equipment) — Gear for working satellites
- [EME / Moonbounce](/satellites/eme-moonbounce) — Bouncing signals off the Moon
- [Meteor Scatter](/satellites/meteor-scatter) — VHF communication via meteor trails
